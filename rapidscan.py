...
tools_fix = [
					...
					[49, "Hackers will be able to read community strings through the service and enumerate quite a lot of information from the target. Also, there are multiple Remote Code Execution and Denial of Service vulnerabilities related to SNMP services.",
